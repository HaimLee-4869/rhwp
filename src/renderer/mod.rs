...
pub fn generic_fallback(font_family: &str) -> &'static str {
    if font_family.is_empty() {
        ...
        return "'Malgun Gothic','맑은 고딕','Apple SD Gothic Neo','Noto Sans KR','Pretendard','함초롬돋움 확장','함초롬돋움','한컴 고딕','한컴산뜻돋움','Source Han Serif K Old Hangul',sans-serif";
    }
    // 고정폭 키워드
        ...
        || font_family.contains("궁서")
    {
        ...
        return "'Batang','바탕','Nanum Myeongjo','AppleMyungjo','Noto Serif KR','Noto Serif CJK KR','함초롬바탕 확장B','함초롬바탕 확장','함초롬바탕','Source Han Serif K Old Hangul',serif";
    }
    // 세리프 키워드 (영문)
    ...
    "'Malgun Gothic','맑은 고딕','Apple SD Gothic Neo','Noto Sans KR','Pretendard','함초롬돋움 확장','함초롬돋움','한컴 고딕','한컴산뜻돋움','Source Han Serif K Old Hangul',sans-serif"
}
...
mod tests {
    ...
    fn test_generic_fallback() {
        let serif = "'Batang','바탕','Nanum Myeongjo','AppleMyungjo','Noto Serif KR','Noto Serif CJK KR','함초롬바탕 확장B','함초롬바탕 확장','함초롬바탕','Source Han Serif K Old Hangul',serif";
        let sans = "'Malgun Gothic','맑은 고딕','Apple SD Gothic Neo','Noto Sans KR','Pretendard','함초롬돋움 확장','함초롬돋움','한컴 고딕','한컴산뜻돋움','Source Han Serif K Old Hangul',sans-serif";
